...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col font-sans text-white selection:bg-[#CFA86E] selection:text-[#080E18]" style={{ backgroundColor: '#080E18' }}>
      {/* Navigation */}
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16 relative">
        <div className="max-w-4xl w-full text-center z-10 relative">
          <h1 className="text-5xl md:text-7xl font-serif text-[#CFA86E] mb-6 tracking-tight">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto text-left">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl font-serif text-white mb-2 group-hover:text-[#CFA86E] transition-colors">Employee Portal</h2>
                <p className="text-gray-400 text-sm">Access your benefits, pay stubs, and internal resources.</p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl font-serif text-white mb-2 group-hover:text-[#CFA86E] transition-colors">HR / Administration</h2>
                <p className="text-gray-400 text-sm">Manage employee data, organizational charts, and company policies.</p>
      ...
      {/* Footer */}
      <footer className="px-8 py-6 text-center text-gray-600 text-xs tracking-widest uppercase border-t border-white/5">
