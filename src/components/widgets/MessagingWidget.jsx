                ...
                <div
                  ...
                  style={{
                    background: isOutgoing
                      ...
                      : 'rgba(0, 0, 0, 0.04)',
                    border: `1px solid ${isOutgoing ? 'rgba(200,169,107,0.2)' : 'rgba(38,38,47,0.15)'}`,
        ...
        {QUICK_MESSAGES.map((msg, i) => (
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.target.style.borderColor = 'rgba(200,169,107,0.25)';
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, rgba(200,169,107,0.2), rgba(13,32,53,0.2))',
      ...
      {isOpen && (
        <div
          ...
          style={{
            ...
            width: 300,
            height: 420,
            boxShadow: '0 8px 40px rgba(0, 0, 0, 0.5), 0 0 80px rgba(200, 169, 107, 0.06)',
          }}
          id="messaging-panel"
        >
          {/* Panel Header */}
